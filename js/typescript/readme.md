...
## Using **never**
The **never** type represents values which are *never* observed. In a return type, this means that function throws an exception or terminates the execution of the program.
